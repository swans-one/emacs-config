...
(ample-zen-with-color-variables
 (custom-theme-set-faces
  ...
  `(font-lock-comment-face ((t (:foreground ,ample-zen-red))))
  `(font-lock-comment-delimiter-face ((t (:foreground ,ample-zen-red-1))))
  ...
  `(font-lock-string-face ((t (:foreground ,ample-zen-green))))
